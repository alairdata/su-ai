...
// Gmail strips <style> tags and most body/html styles.
// The ONLY reliable way to get dark backgrounds in Gmail:
// 1. Use <table> (not <div>) as the outermost wrapper
// 2. Use bgcolor="#0C0C0E" attribute (not just CSS)
// 3. Use inline style AND bgcolor on EVERY background element
// 4. No <style> blocks, no CSS classes
...
(async () => {
  ...
  else console.log('Preview sent OK:', data.id);
})();
